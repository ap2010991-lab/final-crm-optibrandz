import { Bot, BriefcaseBusiness, CalendarDays, CircleDollarSign, ClipboardList, FileText, LayoutDashboard, Megaphone, Settings, Sparkles, Users } from "lucide-react";

// `key` is the permission name checked on both the client and the server.
export const navItems = [
  { label: "Dashboard", short: "Home", href: "/dashboard", icon: LayoutDashboard, key: "dashboard" },
...
export const PRIMARY_MOBILE_KEYS = ["dashboard", "leads", "clients", "invoices"];
